...
async function sendRegisterData(obj){
  ...
  <div className='container w-75 mx-auto '>
    ...
    <h2 className='mb-4 text-info fw-bolder'>Registration Form</h2>
    ...
    <label className='text-muted' htmlFor="phone">Phone Number</label>
      ...
      {loading ? <button type='button' className='btn btn-outline-info fw-bolder px-4'>
      <span class="spinner-border spinner-border-sm " role="status" aria-hidden="true"></span>
        ...
        <h5 className='text-muted  py-3'>Already have an account ? <Link className='text-decoration-none' to={'/login'}><span className='text-muted signIn '>Sign In</span></Link></h5>
